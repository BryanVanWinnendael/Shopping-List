...
const backgroundColors: CategoriesColors = {
    bread: { light: "#A97832", dark: "#8C6126" },
    drinks: { light: "#2F6F8F", dark: "#255A73" },
    housekeeping: { light: "#5F6368", dark: "#4A4E52" },
    meat: { light: "#8A3F39", dark: "#6F312C" },
    fish: { light: "#3F6483", dark: "#305066" },
    "fruit/vegetables": { light: "#4F7A52", dark: "#3D6140" },
    fridge: { light: "#5F84B3", dark: "#4A6C97" },
    dairy: { light: "#B38A5C", dark: "#946F49" },
    world: { light: "#735064", dark: "#5C4051" },
    breakfast: { light: "#B9811C", dark: "#946716" },
    snacks: { light: "#A95E3F", dark: "#874A31" },
    carbs: { light: "#A07A52", dark: "#825F3F" },
    "sugar/desserts": { light: "#955B82", dark: "#774866" },
    "sauce/spices": { light: "#964522", dark: "#77361B" },
    preserved: { light: "#554A44", dark: "#433A35" },
    hygiene: { light: "#4F8784", dark: "#3E6B68" },
    freezer: { light: "#4E79A6", dark: "#3C6085" },
    remaining: { light: "#6B7280", dark: "#4B5563" },
}
